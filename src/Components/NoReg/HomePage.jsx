                            ...
                            <div className='flex justify-between items-center -mt-[4px] -ml-2'>
                                ...
                                <div className="items-center flex-shrink-0 flex gap-2">
                                    ...
                                    <div className="relative text-white flex items-center w-16 h-[32px] rounded-2xl med:w-[130px] med:px-[10px] ">
                                        ...
                                        <select className='border-white border z-10 rounded absolute p-[5px] inset-0 bg-transparent appearance-none text-[#00000000] selection:hidden med:selection:block med:text-white med:ml-[20px] ' name="" id="">
