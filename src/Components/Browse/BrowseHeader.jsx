...
function BrowseHeader() {
    ...
    return (
        <header className={'gradProf transition-all duration-700 h-[41px] sm:px-4 tabl:h-[68px] flex items-center w-full fixed z-[21] ' + (scroll> 5 && "bg-[#141414] " ) }>
            <div className='px-[1.5%] tabl:px-[2.9%] flex justify-between w-full '  >
                <div className='flex items-center gap-[12px] xlg:gap-[45px] '>
                    ...
                    <div className='hed:hidden hoverElem2 '>
                        ...
                        <div id='hoverDiv2' className='z-[21] fixed left-0 sm:left-[5%] top-[3%] hidden h-40 w-[200px]  '>
                    ...
                    <div className='hidden hed:block text-[white]'>
                        <ul className='flex gap-[18px] xlg:text-[14px] xlg:text-[#e5e5e5] text-[10.9px] font-[500] items-center '  >
                            <li className='font-bold'>
                                <Link to={"/browse"}> Ana Sayfa </Link></li>
                ...
                <div className='flex items-center text-white mr-2 gap-3'>
                    ...
                    <div className='py-[3px] px-[6px] hoverElem1 '>
                        ...
                        <div id='hoverDiv1' className='z-[21] fixed sm:right-[10%] tabl:right-[7%]  h-[100px] top-[1%]  min-w-[100px] hidden hed:hidden'>
                            <div className={"z-10 fixed right-[10%] tabl:right-[7%] top-[8%]  min-w-[350px] sm:min-w-[405px] bg-black opacity-85 divide-y border-t-[3px]  divide-gray-100  shadow  "}>
                    ...
                    <div className='h-[32px] w-8 rounded overflow-hidden  ' >
                        ...
                        <div className='hoverElem3 '>
                            ...
                            <div id='hoverDiv3' className='z-[551] fixed right-0 top-[5%] tabl:top-[6%] hidden h-40 w-[200px]  '>
                                <div id="dropdownHover" className={"z-[21] fixed right-[6%] tabl:right-[4%] top-[9%] w-[215px] bg-black opacity-85 divide-y divide-gray-100  shadow  "}>
