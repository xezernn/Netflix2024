...
function BrowseHeader() {
    ...
    return (
        <header className='gradProf h-[41px] sm:px-4 tabl:h-[68px] flex items-center w-full '>
            <div className='px-[1.5%] flex justify-between w-full '  >
                <div className='flex items-center gap-4  '>
                    <Link>
                        <img className=' w-[60px] h-[25px]  sm:w-[70px] sm:h-[30px] md:w-[100px] md:h-[40px] tabl:w-[115px]  ' src={Logo} alt="" />
                    </Link>
                    ...
                    <div className='hed:hidden hoverElem2 '>
                        ...
                        <div id='hoverDiv2' className='z-[11] fixed left-0 sm:left-[5%] top-[3%] hidden h-40 w-[200px]  '>
                            <div id="dropdownHover" className={"z-10 fixed left-0 sm:left-[5%] top-[9%]  w-[55%] max-w-[260px] bg-black opacity-85 divide-y border-t-[3px] divide-gray-100  shadow  "}>
                ...
                <div className='flex items-center text-white mr-2 gap-3'>
                    <div>
                        <div className={"w-0" + (searchClick && ' w-[min-content] transition-[width] h-[35px] border flex bg-black opacity-85 items-center gap-2 ')}>
                    ...
                    <div className='py-[3px] px-[6px] hoverElem1 '>
                        ...
                        <div id='hoverDiv1' className='z-[11] fixed sm:right-[10%]  h-[100px] top-[1%]  min-w-[100px] hidden hed:hidden'>
                            <div className={"z-10 fixed sm:right-[10%] top-[8%]  min-w-[405px] bg-black opacity-85 divide-y border-t-[3px]  divide-gray-100  shadow  "}>
