...
function BrowseHeader() {
    ...
    return (
        <header className={'gradProf transition-all duration-700 sm:px-4 h-[41px] tabl:h-[68px] flex items-center w-full fixed z-[11] bg-[#141414]'  }>
            <div className='px-[4%] sm:px-[1.5%] tabl:px-[2.9%] flex justify-between w-full '  >
                ...
                <div className='flex items-center text-white mr-2 gap-3'>
                    ...
                    <div className='py-[3px] px-[6px] hoverElem1 '>
                        ...
                        <div id='hoverDiv1' className='z-[11] fixed sm:right-[10%] tabl:right-[7%]  h-[100px] top-[1%]  min-w-[100px] hidden hed:hidden'>
