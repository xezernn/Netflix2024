        ...
        <>
            ...
            <main className='w-full h-[94vh] px-16 pt-[20px] pb-[60px] flex items-center justify-center '>
                <div className=''>
                    ...
                    <Link to="/signup/planform" className='block text-center min-w-[340px] md:min-w-[400px] w-full mt-[24px] rounded text-[24px] font-[400] min-h-16 py-[14px] px-[2em] bg-[#e50914] text-white  shadow '>Next</Link>
                </div>
            </main>
            <RegFooter />
        </>
