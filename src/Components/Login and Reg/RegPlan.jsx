                ...
                <div className='tabl:mt-6'>
                    ...
                    <div className='max-w-[560px] xlg:hidden'>
                        ...
                        <div className='mx-auto max-w-[440px]'>
                            <Link to={"/signup/paymentPicker"} className=' block text-center min-w-[300px]  md:min-w-[400px] w-full mt-[24px] rounded text-[24px] font-[400] min-h-16 py-[14px] px-[2em] bg-[#e50914] text-white  shadow '>Next</Link>
