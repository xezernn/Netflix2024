            ...
            <div className=' '>
                <div className='max-w-[440px] mt-[20px]'>
                    ...
                    <div className='flex flex-col gap-[10px] my-4 '>
                        <input className='p-4 text-[1rem] min-w-4 min-h-4 border border-[#808080] rounded ' type="email" placeholder="Email" id="ds" />
                        <input className='p-4 text-[1rem] min-w-4 min-h-4 border border-[#808080] rounded ' type="password" placeholder="Password" id="sd" />
                ...
                <button className=' w-full mt-[24px] rounded text-[24px] font-[400] min-h-16 py-[14px] px-[2em] bg-[#e50914] text-white  shadow '>Next</button>
            </div>
        </main>
    )
}
